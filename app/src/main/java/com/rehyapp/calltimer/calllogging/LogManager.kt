...
class LogManager(_context: Context) {
        ...
        coroutineScope.launch {
            withContext(Dispatchers.Main) {
                ...
                try {
                    ...
                    Log.e(logTag, "Count=" + cursor.count)
    ...
    fun convertToRecentsUIGroupings(rawLogList: MutableList<LogObjectRaw>): MutableLiveData<MutableList<RecentsUIGroupingsObject>> {
                ...
                for (i in 0 until rawLogList.size) {
                    ...
                    if (!isSame) {
                        ...
                        if (TextUtils.equals(
                            ...
                            //display time in timeDayDate field because it occurred today
                            priorGroupItem.groupTimeDayDate = DateFormat.getTimeInstance(
                                DateFormat.SHORT
                                , Locale.getDefault()
                            ).format(newGroupDate)
        ...
        return MutableLiveData(recentsUIGroupedList)
    }
